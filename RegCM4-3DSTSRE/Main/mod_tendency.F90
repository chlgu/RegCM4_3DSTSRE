...
#include <cpmf.inc>
  ...
  subroutine tend
    ...
    !
!    call zenitm(coszrs)
        call   zenitm(coszrs,coszrs_gu,solar_Az) !ChlGu AnHuang Add 3DSTSRE
...
!ChlGu AnHuang Add 3DSTSRE 20210222 debug
!print*,'!ChlGu AnHuang Add 3DSTSRE 20210222 debug'
      call radiation(xyear,loutrad,labsem)
!      print*,'debug mod_tendency'
    end if
