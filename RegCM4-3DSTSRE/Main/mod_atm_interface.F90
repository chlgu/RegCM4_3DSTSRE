...
!ChlGu AnHuang Add 3DSTSRE 20210216
  real(rk8) , public , pointer , dimension(:,:) :: coszrs_gu,solar_Az
!ChlGu AnHuang Add 3DSTSRE 20210216
  ! Cumulus
...
!ChlGu AnHuang Add 3DSTSRE 20210216
call getmem2d(coszrs_gu,jci1,jci2,ici1,ici2,'storage:coszrs_gu')
call getmem2d(solar_Az,jci1,jci2,ici1,ici2,'storage:solar_Az')
!ChlGu AnHuang Add 3DSTSRE 20210216
!print*,'mod_atm_interface.F90'
