!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!To calculate Gridscale up, vp, and wp
...
!              open file and select sub-point
           ...
           print*,'inti1=',inti1,'inti2=',inti2,'intj1=',intj1,'intj2=',intj2
                    ...
                    do ii=inti1,inti2
                      ...
                      tmpu(ii,jj)=cos(tmpa(ii,jj))
                      tmpv(ii,jj)=sin(tmpa(ii,jj))*cos(tmpb(ii,jj))
                      tmpw(ii,jj)=sin(tmpa(ii,jj))*sin(tmpb(ii,jj))
...
!                     !enddo nn
            ...
            potx(i,j)=-999000000.0    
            poty(i,j)=-999000000.0              
            print*,'1233134'
        endif   
 ...
 !         enddo j,endo i  
          ...
          open(51,file='CORDEXEA_u_SRTM_IDW.grd',form='unformatted'&
            &,access='direct',recl=320*240*4)
          write(51,rec=1) potu
          close(51)
          
          open(51,file='CORDEXEA_v_SRTM_IDW.grd',form='unformatted'&
            &,access='direct',recl=320*240*4)
          write(51,rec=1) potv
          close(51)              
            
          open(51,file='CORDEXEA_w_SRTM_IDW.grd',form='unformatted'&
            &,access='direct',recl=320*240*4)
          write(51,rec=1) potw
          close(51) 
